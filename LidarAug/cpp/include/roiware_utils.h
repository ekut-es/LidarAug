 ...
 * https://github.com/open-mmlab/OpenPCDet/blob/master/pcdet/ops/roiaware_pool3d/src/roiaware_pool3d.cpp
 *
 * Which belongs to https://github.com/open-mmlab/OpenPCDet/tree/master
 */
